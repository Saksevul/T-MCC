...
# -*- coding: utf-8 -*-
"""
Created on Sun Oct  3 22:40:24 2021
...
class Jordan:
    ...
    def propagate_backward(self, target, itera, lrate=0.1, momentum=0.1):
        ...
        if itera == 100 or itera == 4000:
            print(itera,self.weights)
        # Return error
        return (error**2).sum()
...
if __name__ == '__main__':
    ...
    network = Jordan(P.shape[1],8,len(np.unique(labels)))
